...
const FieldDiagram = ({
  ...
  const handleOffenseTabChange = useCallback(
    (newTab: OffenseTabId) => {
    ...
    <div className={fullscreen ? "w-full" : "mb-0"}>
      <div className={fullscreen ? "w-full flex flex-col items-center" : "contents"}>
        ...
        >
          ...
          >
            <span className="text-white/50 font-heading text-[10px] font-bold tracking-[0.3em] uppercase">
              Endesone
            </span>
          </div>
          <div
            ...
            <>
              ...
              {[
                ...
                return (
                  <div key={`numlabels-${m.yd}`}>
                    <div
                      className="absolute text-white/30 font-heading font-bold text-[9px] tracking-wider pointer-events-none select-none"
                      style={{ top: `${y}%`, left: "5%", transform: "translateY(-50%)" }}
                    >
                      {m.num}
                    </div>
                    <div
                      className="absolute text-white/30 font-heading font-bold text-[9px] tracking-wider pointer-events-none select-none"
                      style={{ top: `${y}%`, right: "5%", transform: "translateY(-50%)" }}
                    >
                      {m.num}
                    </div>
                  </div>
              ...
              {[5, 10, 15, 20, 25, 30, 35, 40, 45].map((yd) => {
                ...
                return (
                  <div
                    key={`hash-${yd}`}
                    className="absolute left-1/2 -translate-x-1/2 w-2 h-px bg-white/40"
                    style={{ top: `${y}%` }}
                  />
                );
              })}
              ...
              <div
                className="absolute"
                style={{ top: `${LOS_PCT}%`, left: "0%", transform: "translate(2px, -50%)", zIndex: 2 }}
              >
          ...
          >
            ...
            {defenseTab === "soneforsvar" &&
              Object.entries(zoneRectsFor(variant)).map(([id, z]) => {
            ...
            {/* Man-to-man lines */}
            {defenseTab === "mann-mot-mann" &&
              Object.entries(manAssignments).map(([dbId, offId]) => {
                ...
                <>
                  {activeTab === "kastespill" && (
                    <>
                      ...
                      <polyline
                        points={`88,${LOS_PCT} 88,${LOS_PCT - 12 * YD_PCT} 70,${LOS_PCT - 18 * YD_PCT}`}
                        fill="none"
                        stroke="#facc15"
                        strokeOpacity="0.6"
                        strokeWidth="1.8"
                      ...
                      />
                      <polyline
                        points={`72,${LOS_PCT} 72,${LOS_PCT - 10 * YD_PCT} 50,${LOS_PCT - 10 * YD_PCT}`}
                        fill="none"
                        stroke="#facc15"
                        strokeOpacity="0.6"
                        strokeWidth="1.8"
                      ...
                      />
                      <polyline
                        points={`50,${LOS_PCT - 0.8 * YD_PCT} 50,${LOS_PCT - 6 * YD_PCT} 42,${LOS_PCT - 6 * YD_PCT}`}
                        fill="none"
                        stroke="#facc15"
                        strokeOpacity="0.6"
                        strokeWidth="1.8"
                      ...
                      />
                      <polyline
                        points={`12,${LOS_PCT} 12,${LOS_PCT - 8 * YD_PCT} 28,${LOS_PCT - 8 * YD_PCT}`}
                        fill="none"
                        stroke="#facc15"
                        strokeOpacity="0.6"
                        strokeWidth="1.8"
                  ...
                  {activeTab === "løpespill" && (
                    <>
                      ...
                      />
                      <polyline
                        points={`50,${LOS_PCT + 8 * YD_PCT} 56,${LOS_PCT + 1 * YD_PCT} 56,${LOS_PCT - 12 * YD_PCT}`}
                        fill="none"
                        stroke="#4ade80"
                        strokeOpacity="0.7"
                        strokeWidth="2"
                      ...
                      />
                      <polyline
                        points={`50,${LOS_PCT} 50,${LOS_PCT - 6 * YD_PCT}`}
                        fill="none"
                        stroke="white"
                        strokeOpacity="0.5"
                        strokeWidth="1.5"
                      ...
                      />
                      <polyline
                        points={`12,${LOS_PCT} 12,${LOS_PCT - 8 * YD_PCT} 6,${LOS_PCT - 10 * YD_PCT}`}
                        fill="none"
                        stroke="white"
                        strokeOpacity="0.4"
                        strokeWidth="1.2"
                      ...
                      />
                      <polyline
                        points={`88,${LOS_PCT} 88,${LOS_PCT - 8 * YD_PCT} 94,${LOS_PCT - 10 * YD_PCT}`}
                        fill="none"
                        stroke="white"
                        strokeOpacity="0.4"
                        strokeWidth="1.2"
        ...
        <div className={`${widthClass} ${fullscreen ? "sticky bottom-0 z-30" : ""}`}>
          <div
            className={`bg-sky-950/80 backdrop-blur-md ${fullscreen ? "border-t-0" : "border-2 border-t-0 border-sky-400/20 rounded-b-xl"} overflow-hidden`}
          >
            <div className="flex">
              {offenseTabs.map((tab) => (
                <button
  ...
  return (
    ...
    >
      ...
      {isActive && description && (
        <div
          className={`absolute top-full mt-1 w-52 bg-black/90 text-white text-[11px] leading-snug rounded-lg px-3 py-2 shadow-xl ${tooltipAlign}`}
        >
