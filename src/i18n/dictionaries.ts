...
const no = {
  ...
  "try.close": "Lukk",
  "try.h": "Meld interesse",
  "try.sub": "Nysgjerrig på flaggfotball? Legg igjen en uforpliktende interesse så tar vi kontakt før neste trening — dette er ikke en bindende påmelding.",
  "try.note": "Vi sjekker innmeldinger med jevne mellomrom. For raskt svar er det ofte lurere å ta kontakt via Facebook eller Instagram.",
  "try.name": "Navn",
  ...
  "try.submit": "Send interesse",
  "try.submitting": "Sender …",
  "try.success": "Takk! Vi har mottatt interessen din og tar kontakt før neste trening.",
  "try.errorPre": "Noe gikk galt. Prøv igjen, eller kontakt ",
  "try.errorLink": "en av trenerne",
  "try.errorPost": " direkte. Du får som regel raskere svar ved å skrive til oss på Facebook eller Instagram.",
...
const en: Record<TranslationKey, string> = {
  ...
  "try.close": "Close",
  "try.h": "Register interest",
  "try.sub": "Curious about flag football? Drop us a no-strings note and we'll reach out before the next session — this isn't a binding sign-up.",
  "try.note": "We check these every so often. For a quick reply, reaching out via Facebook or Instagram usually works better.",
  "try.name": "Name",
  ...
  "try.submit": "Send interest",
  "try.submitting": "Sending …",
  "try.success": "Thanks! We got your note and will reach out before the next session.",
  "try.errorPre": "Something went wrong. Please try again, or contact ",
  "try.errorLink": "one of the coaches",
  "try.errorPost": " directly. You'll usually get a faster reply by messaging us on Facebook or Instagram.",
