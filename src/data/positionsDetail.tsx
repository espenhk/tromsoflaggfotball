import { Star, Zap, Users, Target, Crosshair, Shield, Eye, ChevronDown } from "lucide-react";
...
export const positionsDetail: PositionData[] = [
  {
    id: "quarterback",
    name: "Quarterback",
    abbr: "QB",
...
export const offensePositionsDetail = offenseOrder.map((id) => byId[id]);
export const defensePositionsDetail = defenseOrder.map((id) => byId[id]);

/** Full expandable position row used on /posisjoner. */
